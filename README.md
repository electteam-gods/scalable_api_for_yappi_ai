...
# <p align="center"> ЭТО РЕПОЗИТОРИЙ С РЕАЛИЗАЦИЕЙ СЕРВИСА, НЕЙРОННАЯ МОДЕЛЬ НАХОДИТСЯ [В ЭТОМ РЕПОЗИТОРИИ](https://github.com/electteam-gods/vidio_comparison_api) </p>
...
<img width="1200" height="500" alt="image" src="https://github.com/NikitaGordievskiy/scalable_api_for_yappi_ai/blob/main/image_2024-09-29_09-20-16.png"> 
